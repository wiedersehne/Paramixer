...
from genome_training_config import config
...
# Parse config
cfg_model = config['ensembl']["Paramixer"]
cfg_training = config['ensembl']['training']
...
# Read the data
data = torch.load('./data/ensembl/Ensembl16384_train.pt').to(torch.int64)
labels = torch.load('./data/ensembl/Ensembl16384_train_targets.pt').to(torch.int64)

data_val = torch.load('./data/ensembl/Ensembl16384_val.pt').to(torch.int64)
labels_val = torch.load('./data/ensembl/Ensembl16384_val_targets.pt').to(torch.int64)

data_test = torch.load('./data/ensembl/Ensembl16384_test.pt').to(torch.int64)
labels_test = torch.load('./data/ensembl/Ensembl16384_test_targets.pt').to(torch.int64)
